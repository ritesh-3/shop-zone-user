  ...
  return (
    <div className="w-full flex flex-col items-center py-8">
      <div className="sm:flex items-start gap-10">
        <div className="w-[90vw] sm:w-[650px]">
          <PaymentInfo
            user={user}
            open={open}
            setOpen={setOpen}
        ...
        <div className="mt-5 sm:m-0 w-[90vw] sm:w-[400px]">
    ...
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8">
          ...
          <div className="w-full flex border-b">
            <form className="w-full" onSubmit={paymentHandler}>
              ...
              <input
                type="submit"
                value="Submit"
                className={`${styles.buttonRed} !bg-[#f63b60] text-[#fff] h-[45px] rounded-[5px] cursor-pointer text-[18px] font-[600]`}
              />
            </form>
          </div>
        ) : null}
      ...
      <div>
        ...
        {select === 2 ? (
          <div className="w-full flex border-b">
            <div
              className={`${styles.buttonRed} !bg-[#f63b60] text-white h-[45px] rounded-[5px] cursor-pointer text-[18px] font-[600]`}
          ...
          <div className="w-full flex">
            <form className="w-full" onSubmit={cashOnDeliveryHandler}>
              <input
                type="submit"
                value="Confirm"
                className={`${styles.buttonRed} cursor-pointer`}
              />
            </form>
          </div>
        ) : null}
